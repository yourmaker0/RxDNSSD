...
// I don't want to change Apple source code
//CHECKSTYLE:OFF
...
{
	/**	Flag indicates to a {@link InternalBrowseListener} that another result is
	...
	*/
	...
	/** If flag is set in a {@link InternalDomainListener} callback, indicates that the result is the default domain. */
	...
	*/
	public static DNSSDService	resolve( int flags, int ifIndex, String serviceName, String regType,
										String domain, InternalResolveListener listener)
	throws DNSSDException
	...
	*/
	public static DNSSDRegistration	register( int flags, int ifIndex, String serviceName, String regType,
									String domain, String host, int port, TXTRecord txtRecord, InternalRegisterListener listener)
	throws DNSSDException
	...
	*/
	public static DNSSDService	queryRecord( int flags, int ifIndex, String serviceName, int rrtype,
										int rrclass, InternalQueryListener listener)
	throws DNSSDException
	...
	*/
	...
	protected InternalDNSSD() {}	// prevent direct instantiation

	/** Return the single instance of DNSSD. */
	static protected final InternalDNSSD getInstance()
	{
	...
	abstract protected DNSSDService	_makeBrowser( int flags, int ifIndex, String regType, String domain, InternalBrowseListener listener)
	throws DNSSDException;
	...
	abstract protected DNSSDService	_enumerateDomains( int flags, int ifIndex, InternalDomainListener listener)
	throws DNSSDException;
	...
	static
	{
		try
		{
			...
			if (name == null)
				name = "com.github.druk.dnssd.AppleDNSSD";	// Fall back to Apple-provided class.
...
class	AppleDNSSD extends InternalDNSSD
{
	...
	protected DNSSDService	_makeBrowser( int flags, int ifIndex, String regType, String domain, InternalBrowseListener client)
	throws DNSSDException
	{
	...
	protected DNSSDService	_resolve( int flags, int ifIndex, String serviceName, String regType,
										String domain, InternalResolveListener client)
	throws DNSSDException
	{
	...
	protected DNSSDRegistration	_register( int flags, int ifIndex, String serviceName, String regType,
									String domain, String host, int port, TXTRecord txtRecord, InternalRegisterListener client)
	throws DNSSDException
	{
	...
	protected DNSSDService		_queryRecord( int flags, int ifIndex, String serviceName, int rrtype,
										int rrclass, InternalQueryListener client)
	throws DNSSDException
	{
		return new AppleQuery( flags, ifIndex, serviceName, rrtype, rrclass, client);
	}

	protected DNSSDService		_enumerateDomains( int flags, int ifIndex, InternalDomainListener listener)
	throws DNSSDException
	{
...
class	AppleRegistration extends AppleService implements DNSSDRegistration
{
	public			AppleRegistration( int flags, int ifIndex, String serviceName, String regType, String domain,
								String host, int port, byte[] txtRecord, InternalRegisterListener client)
	throws DNSSDException
	{
		super(client);
